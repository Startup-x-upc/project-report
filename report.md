...
<img src="./Resources/capitulo_1/foto_dalila.png" width="160">
Soy estudiante de Ingeniería de Software, he programado en C#, C++, PHP, Java y Python, además manejo de bases de datos relacionales. También he trabajado con Git y metodologías ágiles como Scrum, lo cual me ha ayudado a organizarme mejor y a trabajar en equipo con más fluidez. Me interesa mucho el desarrollo backend, porque me gusta entender la lógica detrás de las cosas, cómo se procesan los datos y cómo se asegura que todo funcione correctamente. También me gusta colaborar en el frontend, porque entiendo que un buen producto requiere que ambas partes trabajen en armonía. Disfruto ver cómo una idea se vuelve algo real, desde los primeros bocetos hasta la parte funcional donde las personas terminan usando. Actualmente, mi objetivo es seguir consolidando mis habilidades técnicas y blandas para desempeñarme con confianza en el entorno laboral. Me interesa participar en proyectos donde pueda aplicar lo que sé y aportar soluciones prácticas a problemas reales.
...
<table>
  <tr>
    <td valign="top"><strong>Business Problem</strong><br><br>
<strong>Falta de comunicación.</strong> Los pasajeros y conductores de mototaxi no tienen un método para contactarse entre sí. Esto genera desorden en las zonas de recojo, conductores esperando estáticamente de forma ineficiente y pasajeros incapaces de localizar transporte disponible.<br><br>
<strong>Uso ineficiente del tiempo y combustible.</strong> Sin datos de demanda, los conductores circulan o esperan a ciegas, aumentando los costos operativos de combustible y mantenimiento del vehículo, reduciendo sus ganancias diarias.<br><br>
<strong>Ausencia de sistema de tarifas.</strong> Las tarifas se negocian de forma informal, lo que genera desconfianza, inconsistencia y malas experiencias para los pasajeros, especialmente los nuevos.<br><br>
<strong>Falta de predicción de demanda.</strong> Los conductores no saben qué horas y zonas son más activas, por lo que no pueden planificar su jornada para maximizar sus ganancias.<br><br>
<strong>Problema de percepción.</strong> Los mototaxis tienen una reputación ligada al desorden e informalidad. Sin una plataforma que registre conductores y viajes, los pasajeros no tienen confianza ni respaldo en caso de algún problema.<br><br>
<strong>Exclusión digital de un sector informal.</strong> Los mototaxis operan predominantemente en zonas periféricas de Lima. Sin embargo, las plataformas de transporte existentes no atienden estas zonas y ninguna herramienta digital ha sido diseñada para la realidad específica de estos conductores y pasajeros.<br><br>
<strong>Informalidad como barrera de adopción.</strong> La mayoría de conductores de mototaxi en Lima operan fuera de la economía formal, sin licencias ni vehículos registrados. Cualquier solución que requiera documentación formal excluiría a la mayoría de los usuarios objetivo. El MVP debe priorizar un registro de baja barrera, tratando la formalización como un objetivo a largo plazo.
</td>
    <td rowspan="2" valign="top"><strong>Solutions</strong><br><br>
- Mapa en tiempo real que muestra los conductores disponibles cerca de la ubicación del pasajero.<br>
- Sistema de solicitud de viaje donde el pasajero envía una solicitud y un conductor cercano la acepta.<br>
- Notificaciones push para alertar a los conductores sobre solicitudes cercanas.<br>
- Estimación automática de tarifa basada en la distancia antes de confirmar el viaje.<br>
- Tarifa visible para conductor y pasajero antes de iniciar el viaje.<br>
- Perfil del conductor con foto, nombre e información del vehículo visible para el pasajero antes del viaje.<br>
- Sistema de calificaciones y reseñas para conductores y pasajeros después de cada viaje.<br>
- Historial de viajes accesible para ambos usuarios.<br>
- Mapa de calor de demanda que muestra las zonas con más pasajeros activos por hora del día.<br>
- Resumen de ganancias diarias y conteo de viajes visible en el panel del conductor.
</td>
    <td valign="top"><strong>Business Outcomes</strong><br><br>
<strong>Reducir el tiempo de espera del pasajero.</strong> Los pasajeros deben conectarse con un conductor más rápido que la búsqueda informal actual en la calle.<br><br>
<strong>Reducir el tiempo que un conductor pasa sin pasajero.</strong> Menos tiempo inactivo significa mejor eficiencia de combustible y mayores ganancias diarias.<br><br>
<strong>Generar confianza entre pasajeros y conductores.</strong> Medido a través de la adopción del sistema de calificaciones, la reiteración de uso y la reducción de cancelaciones de viajes.<br><br>
<strong>Establecer una referencia de precios transparente y consistente.</strong> Pasajeros y conductores acuerdan una tarifa antes del viaje, reduciendo los conflictos de negociación.<br><br>
<strong>Generar datos de movilidad desde zonas periféricas.</strong> La aplicación produce datos sobre patrones de demanda, horas pico y zonas activas que actualmente no existen.
</td>
  </tr>
  <tr>
    <td valign="top"><strong>Users</strong><br><br>
<strong>Conductor.</strong> Un conductor de mototaxi que opera en zonas periféricas de Lima. Necesita encontrar pasajeros de manera eficiente para maximizar sus viajes y reducir el desperdicio de combustible y tiempo durante su jornada laboral.<br><br>
<strong>Pasajero.</strong> Un residente de una zona periférica de Lima que utiliza mototaxis como su principal opción de transporte de corta distancia. Necesita encontrar transporte disponible de forma rápida, segura y a un precio justo y predecible.
</td>
    <td valign="top"><strong>User Outcomes & Benefits</strong><br><br>
<strong>Conductor.</strong><br>
- Encontrar pasajeros más rápido sin perder tiempo esperando en zonas desorganizadas.<br>
- Reducir el consumo diario de combustible al saber dónde está la demanda.<br>
- Tener un registro de viajes y ganancias para gestionar mejor sus finanzas.<br>
- Construir una reputación a través de calificaciones que le ayude a obtener más clientes y cambiar la percepción del sector.<br><br>
<strong>Pasajero.</strong><br>
- Encontrar un mototaxi disponible rápidamente sin buscar en la calle.<br>
- Conocer el precio antes del viaje para evitar conflictos de negociación.<br>
- Sentirse más seguro al conocer la identidad del conductor.<br>
- Tener una opción de transporte confiable cerca de su hogar en su zona.
</td>
  </tr>
  <tr>
    <td valign="top"><strong>Hypotheses</strong><br><br>
Creemos que un sistema de notificaciones de solicitud de viaje para los conductores reducirá el tiempo de espera inactivo. Sabremos que esto es verdad cuando los conductores reporten completar más viajes por día en comparación con antes de usar la aplicación.<br><br>
Creemos que un mapa de calor de demanda para los conductores reducirá el consumo diario de combustible. Sabremos que esto es verdad cuando los conductores reporten pasar menos tiempo circulando sin pasajeros.<br><br>
Creemos que un mapa en tiempo real que muestre conductores disponibles cercanos para los pasajeros reducirá el tiempo de búsqueda de transporte. Sabremos que esto es verdad cuando los pasajeros encuentren un conductor en menos de 5 minutos después de abrir la aplicación.<br><br>
Creemos que mostrar el perfil y la calificación del conductor a los pasajeros aumentará su sensación de seguridad. Sabremos que esto es verdad cuando al menos el 70% de los pasajeros califiquen su experiencia positivamente después del primer viaje.
</td>
    <td valign="top"><strong>¿Qué es lo más importante que necesitamos aprender primero?</strong><br><br>
¿Los conductores de mototaxi en Lima realmente usarán una aplicación para encontrar pasajeros, o preferirán seguir trabajando como siempre lo han hecho?<br><br>
¿Los pasajeros en zonas periféricas tienen smartphones con suficiente conectividad de datos para usar un mapa en tiempo real?<br><br>
¿Los pasajeros están dispuestos a solicitar un mototaxi a través de una aplicación en lugar de detener uno en la calle?<br><br>
¿Los conductores están dispuestos a dejar que una aplicación calcule la tarifa, o prefieren negociarla libremente con cada pasajero?
</td>
    <td valign="top"><strong>¿Cuál es la menor cantidad de trabajo que necesitamos hacer para aprender lo siguiente más importante?</strong><br><br>
<strong>Entrevistas.</strong> Entrevistar a conductores de mototaxi preguntando sobre su rutina diaria, problemas principales y disposición para usar una aplicación. Otro sector son los residentes, preguntando cómo encuentran actualmente un mototaxi, cuánto tiempo les toma y si han tenido malas experiencias con las tarifas o la seguridad.<br><br>
<strong>Prototipo.</strong> Mostrarles un prototipo simple o mockups de la interfaz del conductor para observar su reacción y nivel de comodidad con la UI. Esto ayuda a probar el flujo principal, como solicitar un viaje, ver al conductor y confirmar una tarifa.
</td>
  </tr>
</table>
...
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup1.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup2.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup3.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup4.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup5.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup6.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup7.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup8.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup9.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup10.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup11.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup12.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup13.png)
<br><br>
![alt text](Resources/mobile-web-browser-mockups/mobile-web-browser-mockup14.png)
...
### Task Flow 1: Registro en la plataforma
**Objetivo del usuario:** Permite que un usuario nuevo se registre como pasajero o conductor para acceder a los servicios de la plataforma.<br><br>
**Pasos del Task Flow:**
1. Acceder a la pantalla de Login de la aplicación.
2. Seleccionar la opción de "Registrarse".
3. Elegir el tipo de cuenta: Psajero o conductor.
4. Completar el formulario de datos personales.
5. Para conductor: ingresar datos del vehículo y subir documentos requeridos.
6. Confirmar el registro y acceder al Home correspondiente.

#### User Goal 1: Como pasajero nuevo, quiero registrarme en la plataforma para poder solicitar viajes
**User Persona:** Pasajero<br>
...
![alt text](Resources/web-applications-wireflow/user-goal1.jpg)

#### User Goal 2: Como conductor nuevo, quiero registrarme con mis datos personales y vehiculares para poder aceptar viajes
**User Persona:** Conductor<br>
...
![alt text](Resources/web-applications-wireflow/user-goal2.jpg)

### Task Flow 2: Recuperación de acceso
**Objetivo del usuario:** Permitir al usuario recuperar el acceso a su cuenta cuando ha olvidado su contraseña.<br><br>
**Pasos del Task Flow:**
...
4. Recibir el enlace de recuperación en el correo.
5. Completar el proceso de cambio de contraseña.
6. Volver al Login con el nuevo acceso.

#### User Goal 3: Como usuario registrado, quiero recuperar mi contraseña cuando la olvido para poder seguir accediendo a la plataforma
**User Persona:** Pasajero / Conductor<br>
...
![alt text](Resources/web-applications-wireflow/user-goal3.jpg)

### Task Flow 3: Solicitar y gestionar un viaje
**Objetivo del usuario:** Permitir al pasajero solicitar un viaje, hacer seguimiento en tiempo real y calificarlo al finalizar.<br><br>
**Pasos del Task Flow:**
1. Acceder al Home del pasajero e ingresar el destino.
2. Confirmar la solicitud de viaje en el sistema.
3. Esperar la asignación de un conductor disponible (Viaje activo).
4. Monitorear el estado: conductor en camino -> viaje en curso.
5. Completar el viaje y ver el resumen (Finalizado).
6. Calificar al conductor con estrellas y comentarios.

#### User Goal 4: Como pasajero, quiero solicitar un viaje ingresando mi destino para que un conductor me recoja.
**User Persona:** Pasajero<br>
...
![alt text](Resources/web-applications-wireflow/user-goal4.jpg)

#### User Goal 5: Como pasajero, quiero ser notificado si mi solicitud es rechazada para poder intentarlo nuevamente.
**User Persona:** Pasajero<br>
...
![alt text](Resources/web-applications-wireflow/user-goal5.jpg)

#### User Goal 6: Como pasajero, quiero calificar al conductor al finalizar el viaje para contribuir con la reputación del sistema.
**User Persona:** Pasajero<br>
...
![alt text](Resources/web-applications-wireflow/user-goal6.jpg)

### Task Flow 4: Consultar historial y gestionar wallet 
**Objetivo del usuario:** Permitir al pasajero revisar sus viajes anteriores y gestionar su billetera virtual para recargar saldo.<br><br>
**Pasos del Task Flow:**
1. Acceder al Home del pasajero.
2. Navegar a la sección "Historial" para ver viajes pasados.
3. Revisar fecha, destino y costo de cada viaje.
4. Acceder a la sección "Wallet" para ver el saldo actual.
5. Seleccionar "Recargar" e ingresar el monto y método de pago.
6. Confirmar la recarga y verificar el nuevo saldo.

#### User Goal 7: Como pasajero, quiero consultar el historial de mis viajes anteriores para revisar mis gastos y trayectos.
**User Persona:** Pasajero<br>
...
#### User Goal 8: Como pasajero, quiero consultar el historial de mis viajes anteriores para revisar mis gastos y trayectos.
**User Persona:** Pasajero<br>
...
### Task Flow 5: Gestionar viajes como conductor 
**Objetivo del usuario:** Permitir al conductor recibir, aceptar y gestionar solicitudes de viaje para trasladar pasajeros y registrar sus carreras.<br><br>
**Pasos del Task Flow:**
1. Iniciar sesión y acceder al Home del conductor.
2. Activar la disponibilidad para recibir solicitudes.
3. Recibir una solicitud de viaje en la pantalla de Estado.
4. Revisar el detalle de la solicitud y aceptar el viaje.
5. Dirigirse al pasajero (En camino) y recogerlo.
6. Completar el viaje (En curso -> Finalizado) registrando la ganancia.

#### User Goal 9: Como conductor quiero recibir y aceptar solicitudes de viaje para trasladar pasajeros y generar ingresos.
**User Persona:** Conductor<br>
...
**Objetivo del usuario:** Permitir al conductor consultar sus carreras realizadas, gestionar su perfil y cerrar sesión de forma segura.<br><br>
**Pasos del Task Flow:**
1. Acceder al Home del conductor.
2. Navegar a "Mis carreras" para ver el historial de viajes.
3. Revisar fecha, destino, duración y ganancia de cada carrera.
4. Acceder a "Mi Perfil" para ver y editar información personal.
5. Guardar cambios en el perfil o cerrar sesión.

#### User Goal 10: Como conductor, quiero consultar el historial de mis carreras realizadas para controlar mis ingresos y rendimiento
**User Persona:** Conductor<br>
...
#### User Goal 11: Como usuario, quiero ver y editar mi perfil personal y cerrar sesión de forma segura
**User Persona:** Pasajero / Conductor<br>
...
#### Entrevista 3: Conductor de Mototaxi
...
#### Entrevista 4: Pasajera

- Nombre: Karen Guio Gonzales
- Edad: 22 años
- Residencia: No especificada
- Ocupación: Estudiante de Administración
- Fecha: 19 de junio de 2026
- Inicio de la Entrevista: 00:12
- Duración: 22:27

Link: [Ver video](https://upcedupe-my.sharepoint.com/personal/u202322952_upc_edu_pe/_layouts/15/stream.aspx?id=%2Fpersonal%2Fu202322952%5Fupc%5Fedu%5Fpe%2FDocuments%2FChapa%20Tu%20Ruta%2Fu202322952%5FValidaci%C3%B3n%5FPasajera%5FKaren%2Emp4&referrer=StreamWebApp%2EWeb&referrerScenario=AddressBarCopied%2Eview%2Ea0a900c4%2Db3c8%2D429a%2Dbb49%2Ddab72bb0fa68)

Resumen:

Respecto al proceso de registro, indicó que la experiencia fue sumamente intuitiva y clara para una usuaria de su perfil. Mencionó que la interfaz es limpia y fácil de navegar desde el primer contacto.

Durante la simulación de solicitud de viajes, Karen enfatizó que la plataforma debería parecerse más al modelo de negocio de **inDrive**, donde la negociación directa de las tarifas sea la característica principal y el pasajero tenga la capacidad de proponer un precio menor o negociar un precio de partida justo con el conductor. Para ella, tener la opción de bajar la tarifa y llegar a un acuerdo mutuo es el aspecto primordial del servicio de mototaxis.

Asimismo, recomendó mejorar y potenciar las funcionalidades en tiempo real, sugiriendo un seguimiento de geolocalización más dinámico en el mapa interactivo para visualizar con precisión la trayectoria del conductor antes y durante el viaje, lo cual incrementaría significativamente la percepción de seguridad de los usuarios.

Finalmente, concluyó que la aplicación es de gran utilidad práctica para su vida estudiantil y diaria, recomendándola para viajes rápidos y económicos en zonas urbanas periféricas.
...
_Segmento Conductor:_ 6. Registrarse e iniciar sesión como conductor 7. Visualizar y aceptar una solicitud de viaje entrante 8. Consultar el historial de viajes y ganancias 9. Revisar calificaciones y comentarios recibidos de pasajeros
...
_(Incluir captura de pantalla de la sección de pago)_
...
_(Incluir captura de pantalla de la pantalla de selección de origen/destino)_
...
_(Incluir captura de pantalla de la sección de perfil del conductor)_
...
_(Incluir captura de pantalla del paso de carga de documentos)_
...
_(Incluir captura de pantalla de la solicitud de viaje entrante)_
...
_(Incluir captura de pantalla del historial de ganancias)_
