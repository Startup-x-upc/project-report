...
En base al historial del repositorio y la gráfica mostrada, se registran un total de **91 commits** para el informe del proyecto en esta etapa. El desglose de los aportes por cada integrante del equipo es el siguiente:

- **Andy Pillaca Gonzales:** 33 commits
- **Jesús Castillo Vidal:** 21 commits
- **Eduardo Aguirre Ramos:** 17 commits
- **Sebastian Aiquipa Poma:** 11 commits
- **James Delgado Perez:** 5 commits
- **Dalila Torres Sanchez:** 4 commits

## TB1

Durante esta fase, el equipo elaboró el informe base del proyecto, abarcando la primera version de la parte del frontend del desarrollo de nuestro proyecto.

<img src="./Resources/caratula/collaboration_insights1.jpeg">

Figura 2: Gráfico de contribuciones del repositorio del informe del proyecto para TB1, mostrando la actividad de colaboración de todos los miembros del equipo durante la elaboración del informe inicial.

**Resumen de Contribuciones:**
En base al historial del repositorio y la gráfica mostrada, se registran un total de **90 commits** para el informe del proyecto en esta etapa. El desglose de los aportes por cada integrante del equipo es el siguiente:

- **Dalila Torres Sanchez:** 31 commits
- **Eduardo Aguirre Ramos:** 20 commits
- **Jesús Castillo Vidal:** 16 commits
- **Sebastian Aiquipa Poma:** 13 commits
- **Andy Pillaca Gonzales:** 10 commits

## AV2

Durante esta fase, el equipo elaboró el informe base del proyecto con respecto a una mejora significativa en el frontend y una entrega del backend.
...
**Resumen de Contribuciones:**
En base al historial del repositorio y la gráfica mostrada, se registran un total de **23 commits** para el informe del proyecto en esta etapa. El desglose de los aportes por cada integrante del equipo es el siguiente:



- **Eduardo Aguirre Ramos:** 14 commits
- **Andy Pillaca Gonzales:** 3 commits
- **Jesús Castillo Vidal:** 3 commits
- **Sebastian Aiquipa Poma:** 2 commits
- **Dalila Torres Sanchez:** 1 commits
